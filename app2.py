...
#                html.Hr(),
            ...
            html.Div([html.Span([html.Span("Designed with lots of ", style={'display': 'inline-block', 'margin-right': '10'}), html.I(className='fas fa-mug-hot', style={'display': 'inline-block'})]),
