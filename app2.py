...
#                html.Hr(),
            ...
            html.Div([html.Span([html.Span("Designed with lots of &nbsp", style={'display': 'inline-block', 'padding-right': '10'}), html.I(className='fas fa-mug-hot', style={'display': 'inline-block'})]),
